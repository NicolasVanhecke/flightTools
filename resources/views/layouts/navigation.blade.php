<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.flights.index')" :active="request()->routeIs('admin.flights.index')">
                {{ __('Flights') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.messages.index')" :active="request()->routeIs('admin.messages.index')">
                {{ __('Messages') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.pilots.index')" :active="request()->routeIs('admin.pilots.index')">
                {{ __('Pilots') }}
            </x-responsive-nav-link>
        </div>
